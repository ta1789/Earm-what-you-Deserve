        ...
        <div class="main" style="flex-grow:8">
            <div class="container text-center">
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">Farmer | Edit Farmer Details</h1>
                        </div>
                        <ol class="breadcrumb">
                            <li>
                                <span>Farmer</span>
                                ...
                                <div class="col-lg-8 col-md-12">
                                    <div class="panel panel-white">
                                        <div class="panel-heading">
                                            <h5 class="panel-title">Edit Farmer</h5>
                                        </div>
                                        <div class="panel-body">
                                            <?php $sql=mysqli_query($con,"select * from farmerssup where email='".$_SESSION['id']."'");
