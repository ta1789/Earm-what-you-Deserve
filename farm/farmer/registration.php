...
$query=mysqli_query($con,"insert into farmerssup(fullname,address,mno,city,gender,email,password) values('$fname','$address','$mno','$city','$gender','$email','$password')");
if($query)
{
			...
			<div class="card-body">
				<form name="registration" id="registration"  method="post" onSubmit="return valid();">
					...
					<div class="form-group">
						<label class="block"><font color="orange">
							Gender</font>
						</label>
						<div class="clip-radio radio-primary">
							<input type="radio" id="rg-female" name="gender" value="female" >
							<label for="rg-female"><font color="white">
								Female</font>
							</label>
							<input type="radio" id="rg-male" name="gender" value="male">
							<label for="rg-male"><font color="white">
								Male</font>
							</label>
						</div>
					</div>
