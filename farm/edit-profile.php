...
$sql=mysqli_query($con,"Update users set fullname='$fname',address='$address',mno='$mno',city='$city',gender='$gender' where email='$email'");
if($sql)
{
...
{
?>
                                            <h4><?php echo htmlentities($data['fullName']);?>Customer's Profile</h4>
                                            ...
                                            <form role="form" name="edit" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="mno" class="form-control"
                                                        value="<?php echo htmlentities($data['mno']);?>">
                                                </div>
