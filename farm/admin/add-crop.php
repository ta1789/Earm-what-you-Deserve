...
$_SESSION['msg']="Crop Type added successfully !!";
}
                    ...
                    <div class="wrap-content container" id="container">
                        ...
                        <section id="page-title">
                            <div class="row" style="justify-content: center">
                                <div class="col-sm-8">
                                    <h1 class="mainTitle my-5 fw-bold text-center">Admin | Add Crop Type
                                    </h1>
                                </div>
                                        ...
                                        <div class="col-lg-6 col-md-12 text-center">
                                            <div class="panel panel-white">
                                                <div class="panel-heading">
                                                    <h5 class="panel-title fw-bold">ADD Crop Type</h5>
                                                </div>
                            ...
                            <div class="row ">
                                <div class="col-md-12">
                                    <h5 class="over-title margin-bottom-15 fw-bold">Manage <span
                                            class="text-bold">Crop Type</span></h5>
