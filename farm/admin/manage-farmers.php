...
if (isset($_GET['del'])) {
    mysqli_query($con, "delete from farmerssup where id = '" . $_GET['id'] . "'");
                    ...
                    <div class="wrap-content container my-5" id="container">
                        ...
                        <section id="page-title">
                            <div class="row" style="margin-left: 270px;">
                                <div class="col-sm-8">
                                    <h1 class="mainTitle fw-bold text-center">Admin | Manage Farmers</h1>
                                </div>
                            ...
                            <div class="row my-5">
                                <div class="col-md-12">
                                    <h5 class="over-title margin-bottom-15 fw-bold my-3">Manage <span
                                            class="text-bold">Farmers</span></h5>
                                    ...
                                    <table class="table table-hover" id="sample-table-1 my-3">
                                        <thead class="table-dark fw-bold">
                                            <tr>
                                                ...
                                                <th class="hidden-xs">Farmer Name</th>
                                        ...
                                        <tbody>
                                            <?php
$sql = mysqli_query($con, "select * from farmerssup");
$cnt = 1;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="visible-md visible-lg hidden-sm hidden-xs">
                                                        ...
                                                        <a href="manage-farmers.php?id=<?php echo $row['id'] ?>&del=delete"
